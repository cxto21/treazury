...
const DevWarningModal: React.FC<DevWarningModalProps> = ({ onAccept }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/95 backdrop-blur-md animate-fadeIn">
      <div className="relative max-w-2xl mx-4 bg-white dark:bg-black border-2 border-black dark:border-white rounded-lg shadow-[0_0_40px_rgba(0,0,0,0.5)] dark:shadow-[0_0_40px_rgba(255,255,255,0.2)] animate-scaleIn">
        {/* Header */}
        <div className="border-b border-black/20 dark:border-white/20 px-6 py-4 bg-black/5 dark:bg-white/5">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <svg className="relative w-8 h-8 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
            </div>
            <h2 className="text-2xl font-bold text-black dark:text-white tracking-wider uppercase">
        ...
        <div className="bg-cyber-gray/30 border-t border-cyan-500/20 px-6 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="px-6 py-3 bg-black dark:bg-white text-white dark:text-black font-bold rounded-md shadow-lg shadow-black/30 dark:shadow-white/30 hover:shadow-black/50 dark:hover:shadow-white/50 transition-all duration-300 transform hover:scale-105"
          >
